...
var
    ...
    tlSpans = new TimelineMax({
        paused: true
    }),
    tlLeftMenu = new TimelineLite({
        paused: true
    }),
...
if ($('body.interior').length) {
    ...
    compLogo.maskStop = 50, compLogo.maskAlpha = 220, maskFunc(compLogo), tlLoaderInner
}
tlMenu.staggerTo(burgerLines, 0.2, {
    x: '100%',
    ease: Power2.easeIn
}, 0.2).add('animateall').fromTo(slideMenu, 0.6, {
    autoAlpha: 0
}, {
    x: '0%',
    autoAlpha: 1,
    ease: Power4.easeInOut
}, 'animateall').fromTo(menuTitle, 1.2, {
    x: '20%',
    autoAlpha: 0
}, {
    x: '0%',
    autoAlpha: 1,
    ease: Power4.easeInOut
}, 'animateall-=0.2').fromTo(menuItems, 1.2, {
    x: '20%',
    autoAlpha: 0
}, {
    x: '0%',
    autoAlpha: 1,
    ease: Power4.easeInOut
}, 'animateall-=0.2').fromTo(btmLinks, 1.2, {
    x: '20%',
    autoAlpha: 0
}, {
    x: '0%',
    autoAlpha: 1,
    ease: Power4.easeInOut
}, 'animateall-=0.2').staggerTo(closeLines, 0.2, {
    width: '25px',
    ease: Power2.easeIn
}, 0.2, 'animateall+=0.3');
tlLeftMenu.staggerTo(dots, 0.2, {
    scale: '0%',
    ease: Power2.easeIn
}, 0.1).add('animateall').fromTo(slideMenuLeft, 0.6, {
    autoAlpha: 0
}, {
    x: '0%',
    autoAlpha: 1,
    ease: Power4.easeInOut
}, 'animateall').fromTo(leftMenuTitle, 1, {
    x: '-20%',
    autoAlpha: 0
}, {
    x: '0%',
    autoAlpha: 1,
    ease: Power4.easeInOut
}, 'animateall').fromTo(leftMenuContent, 1, {
    x: '-20%',
    autoAlpha: 0
}, {
    x: '0%',
    autoAlpha: 1,
    ease: Power4.easeInOut
}, 'animateall').staggerTo(closeLinesLeft, 0.2, {
    width: '25px',
    ease: Power2.easeIn
}, 0.2, 'animateall+=0.2');
if ($('.highlight-text').length) {
    var firstElem = document.querySelector(".animate-1");
    firstElem.maskStop = 0, firstElem.maskAlpha = 0, maskFunc(firstElem);
    var elemSecond = document.querySelector(".animate-2");
    if ($('.animate-2').length) {
        elemSecond.maskStop = 0, elemSecond.maskAlpha = 0, maskFunc(elemSecond);
        tlSpans.set(highlightSpan1, {
            className: '+=appear'
        }).to(firstElem, 1.8, {
            maskAlpha: 220,
            maskStop: 50,
            onUpdate: maskFunc,
            onUpdateParams: [firstElem],
            ease: Power1.easeInOut
        }, "-=0.5").set(highlightSpan2, {
            className: '+=appear'
        }).to(elemSecond, 1.8, {
            maskAlpha: 220,
            maskStop: 50,
            onUpdate: maskFunc,
            onUpdateParams: [elemSecond],
            ease: Power1.easeInOut
        }, "-=0.1").set(highlightSpan3, {
            className: '+=appear'
        }).set(highlightSpan4, {
            className: '+=appear'
        }).to(swipeInfo, 1.5, {
...
$(".fade-trigger").each(function() {
    var
        ...
        tlFadeBox = new TimelineMax({
            paused: true
        });
    tlFadeBox.fromTo($fadeBoxWrap, 1, {
        autoAlpha: 0
    }, {
        autoAlpha: 1,
        ease: Power4.easeInOut
    }).add('animateall').fromTo(fadeBoxContent, 1, {
        autoAlpha: 0
    }, {
        autoAlpha: 1,
        ease: Power4.easeInOut
    }, 'animateall-=0.5').staggerTo(fadeBoxCloseLines, 0.2, {
        width: '25px',
        ease: Power2.easeIn
    }, 0.2, 'animateall-=0.5');
    $(this).click(function() {
...
$(document).ready(function() {
    ...
    if ($('body.about').length && $(window).width() > 1024) {
        var pinMain = new ScrollMagic.Scene({
            ...
            triggerHook: 0,
            duration: '3200%'
        }).setPin('#main-content .pin-wrapper', {
            pushFollowers: false
        }).addTo(aboutcontroller);
        var secQ2Tl = new TimelineMax();
        secQ2Tl.add('animateall').to($('.sec-quote1'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-quote2'), 1, {
            autoAlpha: 1,
            ease: Power0.easeNone
        }, 'animateall').to($('.sec-quote1 .txt-wrap'), 1, {
            css: {
                top: "-50px"
            },
            ease: Power0.easeNone
        }, 'animateall-=0.4').fromTo($('.sec-quote2 .txt-wrap'), 1, {
            css: {
                top: "50px"
            }
        }, {
        ...
        }).setTween(secQ2Tl).addTo(aboutcontroller);
        var secQ3Tl = new TimelineMax();
        secQ3Tl.add('animateall').to($('.sec-quote2'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-quote3'), 1, {
            autoAlpha: 1,
            ease: Power0.easeNone
        }, 'animateall').fromTo($('.sec-quote2 .txt-wrap'), 1, {
            css: {
                top: "0px"
            }
        }, {
            ...
            ease: Power0.easeNone
        }, 'animateall-=0.4').fromTo($('.sec-quote3 .txt-wrap'), 1, {
            css: {
                top: "50px"
            }
        }, {
        ...
        }).setTween(secQ3Tl).addTo(aboutcontroller);
        var sec3Tl = new TimelineMax();
        sec3Tl.add('animateall').to($('.sec-quote3'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-3'), 1, {
            autoAlpha: 1,
            ease: Power0.easeNone
        }, 'animateall').fromTo($('.sec-quote3 .txt-wrap'), 1, {
            css: {
                top: "0px"
            }
        }, {
            ...
            ease: Power0.easeNone
        }, 'animateall-=0.4').fromTo($('.sec-3 .txt-wrap'), 1, {
            css: {
                top: "50px"
            }
        }, {
        ...
        }).setTween(sec3Tl).addTo(aboutcontroller);
        var sec3aTl = new TimelineMax();
        sec3aTl.add('animateall').to($('.sec-3'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-3a'), 1, {
            autoAlpha: 1,
            ease: Power0.easeNone
        }, 'animateall').fromTo($('.sec-3 .txt-wrap'), 1, {
            css: {
                top: "0px"
            }
        }, {
            ...
            ease: Power0.easeNone
        }, 'animateall-=0.4').fromTo($('.sec-3a .txt-wrap'), 1, {
            css: {
                top: "50px"
            }
        }, {
        ...
        }).setTween(sec3aTl).addTo(aboutcontroller);
        var sec4Tl = new TimelineMax();
        sec4Tl.add('animateall4').to($('.sec-3a'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-4'), 1, {
            autoAlpha: 1,
            ease: Power0.easeNone
        }, 'animateall4').fromTo($('.sec-4 .bg1'), 1, {
            autoAlpha: 0,
            scale: 1
        }, {
            autoAlpha: 1,
            scale: 1.2,
            ease: Power0.easeNone
        }, 'animateall4').fromTo($('.sec-3a .txt-wrap'), 1, {
            css: {
                top: "0px"
            }
        }, {
            ...
            ease: Power0.easeNone
        }, 'animateall4-=0.4').fromTo($('.sec-4 .txt-wrap'), 1, {
            css: {
                top: "50px"
            }
        }, {
        ...
        }).setTween(sec4Tl).addTo(aboutcontroller);
        var sec4aTl = new TimelineMax();
        sec4aTl.add('animateall4a').fromTo($('.sec-4 .bg1'), 1, {
            autoAlpha: 1,
            scale: 1.2
        }, {
            autoAlpha: 0,
        ...
        var sec4aAnimateScene = new ScrollMagic.Scene({
            ...
            triggerHook: 1,
            duration: '120%'
        }).setTween(sec4aTl).addTo(aboutcontroller);
        var sec4bTl = new TimelineMax();
        sec4bTl.add('animateall').to($('.sec-4 .bg2'), 1, {
            autoAlpha: 0,
            scale: 1.4,
            ease: Power0.easeNone
        }, 'animateall').to($('.sec-4 .bg3'), 1, {
            autoAlpha: 1,
            scale: 1.2,
            ease: Power0.easeNone
        }, 'animateall');
        var sec4bAnimateScene = new ScrollMagic.Scene({
            ...
            triggerHook: 1,
            duration: '120%'
        }).setTween(sec4bTl).addTo(aboutcontroller);
        var sec5Tl = new TimelineMax();
        sec5Tl.add('animateall').to($('.sec-4'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-4 .bg3'), 1, {
            autoAlpha: 0,
            scale: 1.4,
            ease: Power0.easeNone
        }, 'animateall').to($('.sec-5 .bg-img'), 1, {
            autoAlpha: 1,
            scale: 1.2,
            ease: Power0.easeNone
        }, 'animateall').to($('.sec-5'), 1, {
            autoAlpha: 1,
            ease: Power0.easeNone
        }, 'animateall').fromTo($('.sec-4 .txt-wrap'), 1, {
            css: {
                top: "0px"
            }
        }, {
            ...
            ease: Power0.easeNone
        }, 'animateall-=0.4').fromTo($('.sec-5 .txt-wrap'), 1, {
            css: {
                top: "50px"
            }
        }, {
        ...
        }).setTween(sec5Tl).addTo(aboutcontroller);
        var blurElem = {
            a: 20
        };
        var sec6Tl = new TimelineMax();
        sec6Tl.add('animateall').to($('.sec-5'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-5 .bg-img'), 1, {
            autoAlpha: 0,
            scale: 1.4,
            ease: Power0.easeNone
        }, 'animateall').to($('.sec-6'), 1, {
            autoAlpha: 1,
            ease: Power0.easeNone
        }, 'animateall').fromTo('.who-we-are .fade-down', 1, {
            css: {
                bottom: "-50px"
            }
        }, {
        ...
        }, 'animateall').fromTo('.who-we-are .fade-up', 1, {
            css: {
                top: "-50px"
            }
        }, {
        ...
        }, 'animateall').to(blurElem, 1, {
            a: 0,
            onUpdate: applyBlur
        }, 'animateall').fromTo($('.sec-5 .txt-wrap'), 1, {
            css: {
                top: "0px"
            }
        }, {
            ...
            ease: Power0.easeNone
        }, 'animateall-=0.4').fromTo($('.sec-6 .txt-wrap'), 1, {
            css: {
                top: "50px"
            }
        }, {
        ...
        }).setTween(sec6Tl).addTo(aboutcontroller);

        function applyBlur() {
            TweenMax.set($('.who-we-are .blur-img'), {
                webkitFilter: "blur(" + blurElem.a + "px)",
                filter: "blur(" + blurElem.a + "px)"
            });
        }
        var blurElem1 = {
            b: 20
        ...
        sec7Tl.add('animateall').to($('.sec-6'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-7'), 1, {
            autoAlpha: 1,
            ease: Power0.easeNone
        }, 0).fromTo('.who-we-are .fade-down', 1, {
            css: {
                bottom: "50px"
            }
        }, {
        ...
        }, 0).fromTo('.img-showcase .fade-down', 1, {
            css: {
                bottom: "-50px"
            }
        }, {
        ...
        }, 0).fromTo('.img-showcase .fade-up', 1, {
            css: {
                top: "-50px"
            }
        }, {
        ...
        }).setTween(sec7Tl).addTo(aboutcontroller);

        function applyBlur1() {
            TweenMax.set($('.img-showcase .blur-img'), {
                webkitFilter: "blur(" + blurElem1.b + "px)",
                filter: "blur(" + blurElem1.b + "px)"
            });
        }
        var sec8Tl = new TimelineMax();
        sec8Tl.add('animateall').to($('.sec-7'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-8'), 1, {
            autoAlpha: 1,
        ...
        }).setTween(sec8Tl).addTo(aboutcontroller);
        var sec8aTl = new TimelineMax();
        sec8aTl.add('animateall').to($('.sec-8'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-8a'), 1, {
            autoAlpha: 1,
            ease: Power0.easeNone
        }, 'animateall').fromTo($('.sec-8 .txt-wrap'), 1, {
            css: {
                top: "0px"
            }
        }, {
            ...
            ease: Power0.easeNone
        }, 'animateall-=0.4').fromTo($('.sec-8a .txt-wrap'), 1, {
            css: {
                top: "50px"
            }
        }, {
        ...
        }).setTween(sec8aTl).addTo(aboutcontroller);
        var logoLength = $('.award-logo');
        var sec9Tl = new TimelineMax();
        var sec9aTl = new TimelineMax({
            paused: true
        });
        sec9Tl.add('animateall').to($('.sec-8a'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-9'), 1, {
            autoAlpha: 1,
            ease: Power0.easeNone
        }, 0).fromTo($('.sec-8a .txt-wrap'), 1, {
            css: {
                top: "0px"
            }
        }, {
        ...
        sec9aTl.staggerFromTo($('.award-logo'), 1, {
            autoAlpha: 0
        }, {
            autoAlpha: 1,
            ease: Power0.easeNone
        ...
        var sec9AnimateScene = new ScrollMagic.Scene({
            ...
            sec9aTl.play();
        }).setTween(sec9Tl).addTo(aboutcontroller);
        var sec9bTl = new TimelineMax();
        sec9bTl.add('animateall').to($('.sec-9'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-9b'), 1, {
            autoAlpha: 1,
            ease: Power0.easeNone
        }, 0).fromTo($('.sec-9b .txt-wrap'), 1, {
            css: {
                top: "50px"
            }
        }, {
        ...
        }).setTween(sec9bTl).addTo(aboutcontroller);
        var sec10Tl = new TimelineMax();
        sec10Tl.add('animateall').to($('.sec-9b'), 1, {
            autoAlpha: 0,
            ease: Power0.easeNone
        }).to($('.sec-10'), 1, {
            autoAlpha: 1,
            ease: Power0.easeNone
        }, 'animateall').fromTo($('.sec-10 .txt-wrap'), 1, {
            css: {
                opacity: 0,
                top: "50px"
            }
        ...
        }).setTween(sec10Tl).addTo(aboutcontroller);
        var sec11Tl = new TimelineMax();
        sec11Tl.add('animateall').to($('.sec-10'), 1, {
            y: '-100%',
            ease: Power0.easeNone
        }).to($('#footer,.footer-video'), 1, {
            css: {
                visibility: 'visible'
            },
            ease: Power0.easeNone
        ...
        var sec11AnimateScene = new ScrollMagic.Scene({
            ...
            triggerHook: 1,
            duration: '120%'
        }).setTween(sec11Tl).addTo(aboutcontroller);
    }
    ...
    tlTitlefade.fromTo($('.page-title'), 1, {
        autoAlpha: 1
    }, {
        autoAlpha: 0,
        ease: Power4.easeInOut
    ...
    new ScrollMagic.Scene({
        ...
        triggerHook: 0.5,
        duration: '50%'
    }).setTween(tlTitlefade).addTo(controller);
    ...
    if ($('.next-post').length) {
        new ScrollMagic.Scene({
            ...
            triggerHook: 'onLeave',
            offset: 300
        }).setClassToggle('.next-post', 'next-post-on').addTo(controller);
        new ScrollMagic.Scene({
            triggerElement: '#footer',
            triggerHook: 'onEnter'
        }).setClassToggle('.next-post', 'next-post-off').addTo(controller);
    }
    if ($('.show-bar').length) {
        new ScrollMagic.Scene({
            triggerElement: '.show-bar',
            triggerHook: 0.5
        }).setClassToggle('.btm-sticky-bar', 'show-bar').addTo(controller);
        new ScrollMagic.Scene({
            triggerElement: '#footer',
            triggerHook: 1
        }).setClassToggle('.btm-sticky-bar', 'hide-bar').addTo(controller);
    }
    ...
    if ($('body.about').length) {
        new ScrollMagic.Scene({
            ...
            triggerHook: 1,
        }).setClassToggle('#header', 'hidden').addTo(controller);
    } else {
        new ScrollMagic.Scene({
            triggerElement: '#footer',
            triggerHook: 'onLeave',
    ...
    function desktopstaggerupanimation(animateupdesktopcontroller) {
        $('.desktopanimateup1').each(function() {
            ...
            var animatescene = new ScrollMagic.Scene({
                ...
                triggerHook: 0.9,
                reverse: false,
            }).setTween(animateupTl).addTo(animateupdesktopcontroller);
        });
    ...
    function tabletstaggerupanimationalt(animateuptabletaltcontroller) {
        ...
        $('.tabletanimateupalt').each(function() {
            ...
            new ScrollMagic.Scene({
                ...
                triggerHook: 0.9,
                reverse: false,
            }).setTween(animateupTl).addTo(animateuptabletaltcontroller);
        });
    }
    ...
    function tabletstaggerupanimation(animateuptabletcontroller) {
        $('.tabletanimateup1').each(function() {
            ...
            var animatescene = new ScrollMagic.Scene({
                ...
                triggerHook: 0.9,
                reverse: false,
            }).setTween(animateupTl).addTo(animateuptabletcontroller);
        });
    ...
    function mobilestaggerupanimation(animateupmobilecontroller) {
        $('.mobileanimateup').each(function() {
            ...
            new ScrollMagic.Scene({
                ...
                triggerHook: 0.9,
                reverse: false,
            }).setTween(animateupTl).addTo(animateupmobilecontroller);
        });
    }
    ...
    $(window).scroll(function() {
        ...
        if (upper > 300) {
            ...
            if ($('body.interior').hasClass('page-template-template-about')) {} else if ($('body.interior').hasClass('page-template-template-contact')) {} else if ($('body.interior').hasClass('page-template-template-sub-careers')) {} else if ($('body.interior').hasClass('single')) {
    ...
    if ($('body.site-loaded').length) {
        ...
        $('html.no-touch .split-text-wrap').each(function() {
            var
                splitObj = [],
                tltopSplitText = new TimelineMax({
                    delay: 1
                });
            var animateText = new SplitText($(this).find('.split-text'), {
                type: 'lines,chars'
            });
            tltopSplitText.staggerTo($(this).find('.fadespantop'), 0, {
                className: '+=appear'
            }, 0.5, "-=1");
            tltopSplitText.staggerTo($(this).find('.fadespan'), 0, {
                className: '+=appear',
                onComplete: function() {
            ...
            for (var r = 0; r < splitObj.length; r++) {
                tltopSplitText.staggerFrom(splitObj[r], 0.1, {
                    opacity: 0,
                    delay: 0 * r
                }, 0.015, 0);
            }
            new ScrollMagic.Scene({
                triggerElement: this,
                triggerHook: 0.8
            }).setTween(tltopSplitText).addTo(controller);
        });
    } else {
        if ($('.home').length) {
            $("body").queryLoader2({
                ...
                onComplete: function() {
                    for (var i = 0; i < numChars; i++) {
                        tlSplitText.set(mySplitText.chars[i], {
                            className: 'disappear'
                        }, Math.random() * 2);
                        if (i == (numChars - 1)) {
                            tlSplitText.to(author, 2, {
                                delay: 2,
                                y: '10px',
                                opacity: 0,
                                onComplete: a1
            ...
            $("#loader-logo").queryLoader2({
                ...
                onComplete: function() {
                    ...
                    $('html.no-touch .split-text-wrap').each(function() {
                        ...
                        for (var r = 0; r < splitObj.length; r++) {
                            tltopSplitText.staggerFrom(splitObj[r], 1.5, {
                                opacity: 0,
                                delay: .5 * r
                            }, .04, 0);
                        }
